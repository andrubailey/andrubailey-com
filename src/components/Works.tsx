...
export default function Works({
  ...
  return (
    <section className="bg-soft py-24">
          ...
          <Reveal key={project._id} delay={i * 80}>
            ...
            >
              <div className="flex flex-col justify-center p-10 sm:p-12">
                ...
                <span className="mt-8 inline-flex h-12 w-full items-center justify-center rounded-full bg-accent px-6 text-[16px] font-medium tracking-[-0.32px] text-ink transition-transform duration-300 group-hover:scale-[1.04] sm:w-fit">
                  View Project
                </span>
              </div>
              {project.image ? (
      ...
      {showSeeAll && (
        <Reveal className="mx-auto mt-10 flex max-w-5xl justify-center px-6">
          <Link
